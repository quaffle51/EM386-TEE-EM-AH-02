% !TeX root = ./TMA02.tex
Given that the code $C = H\ *\ S$ is formed using Plotkin's $(\bm{a}|\bm{a} + \bm{b})$ construction where $H =\textrm{Ham}(3,2)$ and $S =\textrm{Sim}(3,2)$ then length, dimension and minimum distance of $C$ are determined as follows.
